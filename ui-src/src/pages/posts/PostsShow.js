    ...
    <ShowController title={<PostTitle />} {...props}>
        {controllerProps => (
            <ShowView {...props} {...controllerProps}>
                <TabbedShowLayout>
                    <Tab label={translate("post.form.summary")}>
                        <TextField source="id" />
                    ...
                    <Tab label={translate("post.form.body")}>
                        <RichTextField
                            source="body"
                            stripTags={false}
                            label=""
                    ...
                    <Tab label={translate("post.form.miscellaneous")}>
                    ...
                    <Tab label={translate("post.form.comments")}>
                        <ReferenceManyField
                            addLabel={false}
                            reference="comments"
                            target="post_id"
