...
function createData(originDate: string, completionDate: string, counterparty:any, amount:any, status: any, action:any, notes:any) {
    id += 1;
    return { id, originDate, completionDate, counterparty, amount, status, action, notes };
}
      ...
      <Table className={classes.muiSimpleTable}>
        ...
        <TableBody>
          <TableRow key={currentRow.id}>
            ...
            <TableCell component="th" scope="currentRow">{currentRow.completionDate}</TableCell>
